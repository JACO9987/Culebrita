...
/* ==========================================
CONTROLES TÁCTILES DEL CELULAR
========================================== */

document.getElementById("arriba").addEventListener(
"click",
function() {
...
document.getElementById("abajo").addEventListener(
"click",
function() {
...
document.getElementById("izquierda").addEventListener(
"click",
function() {
...
document.getElementById("derecha").addEventListener(
"click",
function() {
